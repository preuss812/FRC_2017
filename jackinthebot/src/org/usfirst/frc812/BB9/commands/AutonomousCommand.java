...
//				{RobotMap.dtProductionRobotDrive.drive(0.5, 0);}}}
			...
			//double encTicksEnd = Robot.drivelineSubsystem.leftCounter.get();
			//System.out.println("After" + encTicksEnd);
			//System.out.println("Intake Switch Value:" + intakeSwitch);
			
			//break;}
			// intake switch 
			// 00 - left, 10 center, 11 right
			

			int bitMask = Robot.controlBoxSubsystem.flagBits;
			int intakeSwitch = bitMask & 0x0003;
			System.out.println("Intake Switch Value:" + intakeSwitch);
			...
			case 0: //Left
				...
				double encTicksEnd = Robot.drivelineSubsystem.leftCounter.get();
				System.out.println("After0" + encTicksEnd);
				System.out.println("Intake Switch Value-0:" + intakeSwitch);
			...
			case 2: //Center
				...
				for (int i=0; i<120; i++)
					RobotMap.dtProductionRobotDrive.drive(0.5, 1);
				
				double encTicksEnd2 = Robot.drivelineSubsystem.leftCounter.get();
				System.out.println("After2" + encTicksEnd2);
				System.out.println("Intake Switch Value-2:" + intakeSwitch);
			...
			case 3: //Right
				...
				System.out.println("Intake Switch Value-3:" + intakeSwitch);
				break;
				
			default: 
				//System.out.println("Incorrect switch position");
			}
