 ...
 */
public class ADIS16448_IMU_backup_dans_additions extends GyroBase implements Gyro, PIDSource, LiveWindowSendable {
  ...
  private static class AcquireTask implements Runnable {
    private ADIS16448_IMU_backup_dans_additions imu;
    public AcquireTask(ADIS16448_IMU_backup_dans_additions imu) {
      this.imu = imu;
    }
  ...
  private static class CalculateTask implements Runnable {
    private ADIS16448_IMU_backup_dans_additions imu;
    public CalculateTask(ADIS16448_IMU_backup_dans_additions imu) {
      this.imu = imu;
    }
   ...
   * Constructor.
   */
  public ADIS16448_IMU_backup_dans_additions(Axis yaw_axis, AHRSAlgorithm algorithm) {
    m_yaw_axis = yaw_axis;
    ...
    while(!found_imu && find_attempts < 8){
   ...
   */
  public ADIS16448_IMU_backup_dans_additions(Axis yaw_axis) {
   ...
   */
  public ADIS16448_IMU_backup_dans_additions() {
